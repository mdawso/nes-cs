...
- The emulator acts as an interpreter, stepping through memory and changing state depending on the instruction at the program counter. The implementation is entirely LLE.
- This is an emulator of an NTSC NES. It runs at 60fps.
...
- [Opcode matrix](https://www.oxyron.de/html/opcodes02.html)
